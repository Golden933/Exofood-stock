...
aside{background:#171717;color:#fff;padding:28px 18px}.logo{font-size:25px;font-weight:800;margin-bottom:35px}.logo span{color:#ff7a00}.nav{padding:12px;border-radius:10px;margin:5px 0}.nav.active{background:#ff7a00}
...
</style></head><body><div class="layout"><aside><div class="logo">Exo<span>'Food</span></div><div class="nav active">Dashboard</div><div class="nav">Produits</div><div class="nav">Mouvements</div><div class="nav">Alertes</div><div class="nav">Fournisseurs</div></aside>
<main><div class="top"><div><h1>Gestion des stocks</h1><div class="muted">Tableau de bord — Exo'Food Montpellier</div></div><div>Administrateur</div></div>
...
<div class="grid"><section class="panel"><h2>Produits</h2><table><tr><th>Produit</th><th>Stock</th><th>Seuil</th><th>Fournisseur</th><th>Statut</th></tr>
