...
$allowed=['dashboard','products','movements','alerts','suppliers']; if(!in_array($page,$allowed,true))$page='dashboard';
...
<a href="#"><span class="ico">▥</span><span>Rapports</span></a><a href="#"><span class="ico">⚙</span><span>Paramètres</span></a></nav>
